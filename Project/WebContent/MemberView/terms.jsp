...
function checkTerm(){
	...
	if(document.frm.termCheck.checked != true){
		alert("약관에 동의해주세요");
		return false;
	} 
...
<center>
<form action="join.tb" method="post" name="frm">
약관에 동의하면 체크해주세요<br/>

동의(필수) <input type="checkbox" name="termCheck"><br/>
<a href ="javascript:checkTerm();">회원가입</a>
</form>
</center>
</body>
</html>